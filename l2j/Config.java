...
public final class Config
{
	...
	public static final void loadGameServer()
	{
		...
		loadServer();
				...
				// ================== TvT INTEGRATION (CONFIG STAGE) ==================
				try {
					net.sf.l2j.gameserver.custom.tvt.TvTConfig.load();
					if (net.sf.l2j.gameserver.custom.tvt.TvTConfig.ENABLED)
						_log.info("TvT: (Config stage) Loaded (Enabled=true). Initialization will occur after ThreadPool.init().");
					else
						_log.info("TvT: (Config stage) Disabled (Enabled=false).");
				} catch (Throwable t) {
					_log.warning("TvT: load failed: " + t.getMessage());
				}
				// ====================================================================
	}
