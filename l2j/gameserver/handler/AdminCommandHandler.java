...
import net.sf.l2j.gameserver.handler.admincommandhandlers.AdminTvT;
import net.sf.l2j.gameserver.handler.admincommandhandlers.AdminPvpBot;
import net.sf.l2j.gameserver.handler.admincommandhandlers.AdminBotBuffs; // <-- NEW
...
public class AdminCommandHandler
{
	...
	protected AdminCommandHandler()
	{
		...
		// TvT (custom handler)
		registerAdminCommandHandler(new AdminTvT());
		
		// New PvP Bot manual handler
		registerAdminCommandHandler(new AdminPvpBot());
	...
	public IAdminCommandHandler getAdminCommandHandler(String adminCommand)
	{
		...
		int idx = adminCommand.indexOf(' ');
		if (idx != -1)
			command = adminCommand.substring(0, idx);
